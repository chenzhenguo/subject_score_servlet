    ...
    <div class="container-fluid">
                ...
                <div class="sidebar-nav">
                  <div class="nav-header" data-toggle="collapse" data-target="#dashboard-menu">系统管理</div>
                    <ul id="dashboard-menu" class="nav nav-list collapse in">
                        ...
                        <li  class="active" ><a href="dept">部门管理</a></li>
     ...
     <h1 class="page-title">部门管理管理</h1>
			...
			<div class="well search-well">
                <form id="searchForm" class="form-inline" action="dept" method="post">
                    <input class="input-xmax" placeholder="部门名称" name="name" type="text" value="${dept.name }">
                    <input class="input-xmax"  pull-left" placeholder="部门经理" name="manager" type="text" value="${dept.manager }">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
              ...
              <a href="#myModal" onclick="deletePosition('${dept.id}');" role="button" data-toggle="modal"><i class="icon-remove"></i></a>
          </td>
        </tr>
      	</c:forEach>
      </tbody>
...
<div class="pagination">
    ...
    <ul>
        ...
        <li><a href="javascript:pageFunction('dept?action=list&currentPage=${page.currentPage-1 }')">Prev</a></li>
        </c:if>
        <c:choose>
        	<%-- 只要总页数小于10直接显示所有页数 --%>
        	<c:when test="${page.totalPage<10 }">
        		  <c:forEach begin="1" end="${page.totalPage }" var="pc" step="1">
	        	 	<li><a href="javascript:pageFunction('dept?action=list&currentPage=${pc }')">${pc }</a></li>
	        	  </c:forEach>
        	</c:when>
        	<%-- 总页数大于10 --%>
        	<c:otherwise>
        ...
        <li><a href="javascript:pageFunction('dept?action=list&currentPage=${page.currentPage+1 }')">Next</a></li>
    </ul>
</div>
...
<div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
	    ...
	    <div class="modal-body">
	    	是否确定删除?
	    <form id="uploadForm" action="dept" method="post">
