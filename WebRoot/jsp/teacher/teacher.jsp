    ...
    <div class="container-fluid">
        ...
        <div class="span9">
				...
				<div class="well search-well">
					<form id="searchForm" class=form-inline action="teacher" method="post">
						<input class="input-mini" placeholder="教师姓名" name="name"
							type="text" "> 
							<input class="input-mini" placeholder="工作时间" name="workAge" type="text"
							> 
							
							<input class="input-small"
							placeholder="部门" name="deptName" type="text"
							> 
							
							
							<input class="input-small"
							placeholder="职位" name="pName" type="text" value="${sb.pName }">
							
								
							<input class="input-small"
							placeholder="入职时间" name="hireDate" type="text" value="${sb.hireDate}">
				...
				<div class="well">
				 ...
				 <a href="#toDelete" onclick="deleteStudent('${bean.id}');" role="button"
...
<div class="pagination">
    ...
    <ul>
        <li><a href="javascript:pageFunction('teacher?action=list&currentPage=${page.currentPage-1 }')">Prev</a></li>
        <c:choose>
        	<%-- 只要总页数小于10直接显示所有页数 --%>
        	<c:when test="${page.totalPage<10 }">
        		  <c:forEach begin="1" end="${page.totalPage }" var="pc" step="1">
	        	 	<li><a href="javascript:pageFunction('teacher?action=list&currentPage=${pc }')">${pc }</a></li>
	        	  </c:forEach>
        	</c:when>
        	<%-- 总页数大于10 --%>
        	<c:otherwise>
        ...
        <li><a href="javascript:pageFunction('teacher?action=list&currentPage=${page.currentPage+1 }')">Next</a></li>
    </ul>
</div>
