    ...
    <div class="container-fluid">
        ...
        <div class="span9">
			...
			<div class="well search-well">
                <form id="searchForm" class="form-inline" action="subject" method="post">
                    <input class="input-xlarge pull-left" placeholder="课程名称" name="name" type="text" value="${subject.name }">
